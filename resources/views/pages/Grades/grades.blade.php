            ...
            <table id="datatable" class="table table-striped table-bordered p-0">
              <thead>
                  <tr>
                      ...
                      <th>{{ __('grades_trans.Operations') }}</th>
                  </tr>
              </thead>
              <tbody>
                  <?php $i = 0; ?>
                  ...
                  <tr>
                      ...
                      <td>{{ $grade -> notes }}</td>
                      <td>
                          <button type="button" class="class=btn btn-info btn-sm" data-toggle="modal"
                                  data-target="#edit{{ $grade->id }}"
                                  title="{{ __('grades_trans.Edit') }}"><i
                                  class="fa fa-edit"></i></button>
                          <button type="button" class="class=btn btn-danger btn-sm" data-toggle="modal"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('grades.update', 'test') }}" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-success">{{ trans('grades_trans.Save') }}</button>
                                                </div>
                                            </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                    data-dismiss="modal">{{ trans('grades_trans.Close') }}</button>
                <button type="submit" class="btn btn-success">{{ trans('grades_trans.Save') }}</button>
            </div>
            </form>
